...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Base overlay — softens the video without killing it */}
      <div className="absolute inset-0 bg-black/35" aria-hidden="true" />

      {/* Bottom gradient — heavy, guarantees text legibility on any video frame */}
      <div
        className="absolute bottom-0 inset-x-0 h-64 sm:h-80 md:h-[28rem] bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="absolute bottom-0 inset-x-0 z-10 px-6 sm:px-10 md:px-16 pb-10 sm:pb-14 md:pb-20">
        ...
        {/* Tagline + CTAs */}
        <div
          className="mt-4 sm:mt-5 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 transition-all duration-700"
          style={{ opacity: visible ? 1 : 0, transitionDelay: '300ms' }}
        >
          <p className="text-white/60 uppercase tracking-[0.3em] text-xs sm:text-sm shrink-0">
